...
<body onload=display_ct();>
  <div class="flex flex-wrap" id="incomebody">
    ...
    <div class="shadow-lg rounded-lg overflow-hidden mx-auto mt-5 barchart" style="width: 650px;">
                  ...
                  <div class="relative bg-white rounded-lg shadow bg-emerald-300">
                    ...
                    <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b border-white">
                      <button data-modal-hide="" type="submit" href="{{route('editincome',$income->id)}}"
                        class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Update Data
                      </button>
  ...
  <div id="incomeModal" data-modal-backdrop="static" tabindex="-1"
    ...
    <div class="relative w-full h-full max-w-lg md:h-auto">
      ...
      <div class="relative bg-white rounded-lg shadow bg-emerald-300">
        <!-- Modal header -->
        <div class="flex items-center justify-between p-5 border-b rounded-t border-white">
          <h3 class=" text-xl font-medium text-black">Income Form</h3>
          <button type="button"
            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white"
  ...
  @if ($errors->any())
  <script src="{{ asset('js/income-modal-validation.js') }}"></script>
  @endif
</body>
<!-- jQuery -->
...
<script src="{{ asset('jquery/overview-table.js') }}"></script>
<script src="{{ asset('js/income-timeout.js') }}"></script>
<script>
// BAR CHART
  const sunday = "{{$sunday}}";
  const monday = "{{$monday}}";
