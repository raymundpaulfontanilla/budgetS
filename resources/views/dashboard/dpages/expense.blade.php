            ...
            <div class="relative w-full h-full max-w-md md:h-auto">
              <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6 text-center">
                  ...
                  <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to remove
                    this
                    record?</h3>
                  <a href="{{route('deleteexpense',$expense->id)}}"><button data-modal-hide="popup-modal" type="button"
              ...
              <div class="relative bg-white rounded-lg shadow bg-emerald-300">
                ...
                <div class="px-6 py-6 lg:px-8">
                  <form class="space-y-6" method="POST" action="{{route('editexpense',$expense->id)}}">
                    ...
                    <div>
                      <div>
                        <label for="editexpensename" class="block mb-2 text-base font-medium text-black">Select Income
                          Category</label>
