...
@section('content')
    <div class = "container-fluid vh-100 mt-5 pt-5">
        ...
        <img src="{{ asset('images/examples-of-company-profile-pages.jpg') }}" class = "img-fluid" style = "height: 75vh; width: 900px; border-top-left-radius:30px; border-bottom-left-radius:30px;" />
        </div>
        <div class = "col-lg-6">
