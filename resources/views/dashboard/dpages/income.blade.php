...
<div class="pb-5">
  ...
  {{--  class="bg-teal-400 hover:bg-teal-600 text-white font-bold py-2 px-4 rounded-full mt-5" --}}
  {{-- Income Modal --}}
  ...
  <div class="fixed z-10 overflow-y-auto top-0 w-full left-0 hidden" id="incomemodal">
