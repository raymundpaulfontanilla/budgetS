...
<div class="flex flex-wrap">
  ...
  <div class="container w-full md:w-4/5 xl:w-3/5" style="width:100%">
    <button class="bg-teal-400 hover:bg-teal-600 text-white font-bold py-2 px-4 rounded-full mt-3 mb-2" onclick="toggleIncomeModal()">Add Income</button>
    <!--Card-->
        ...
        <div class="flex items-center justify-center min-height-100vh pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          <div class="fixed inset-0 transition-opacity">
            <div class="absolute inset-0 bg-gray-900 opacity-75">
              <button class="bg-white hover:bg-gray-200 text-gray-800 font-bold py-2 px-4 rounded-full absolute top-0 right-0 m-4" onclick="toggleIncomeModal()">X</button>
            </div>
